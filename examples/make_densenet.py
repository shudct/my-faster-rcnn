...
def densenet(data_file, mode='train', batch_size=64, depth=31, first_output=16, growth_rate=12, dropout=0.2):
...
def make_net():
    ...
    with open('train_dense31net.prototxt', 'w') as f:
    ...
    with open('test_dense31net.prototxt', 'w') as f:
...
def make_solver():
    ...
    s.train_net = 'train_dense31net.prototxt'
